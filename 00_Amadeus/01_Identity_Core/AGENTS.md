...
#### **1. USS Orville (Meaning Engine)** - *Ikigai*
* **[A2] Orville**: **Manager of Meaning**. `agents/L1_A2_USS_Orville.md`
...
#### **2. USS Discovery (Balance Engine)** - *Life Wheel*
...
* **[A2] Cerritos**: **Manager of Chaos**. `agents/L1_A2_USS_Cerritos.md`
...
* **[A2] Protostar**: **Manager of Liberation**. `agents/L1_A2_USS_Protostar.md`
    * **Crew**: [Dal](agents/L1_A3_Dal.md) (Delegate), [Rok-Tahk](agents/L1_A3_RokTahk.md) (Eliminate), [Zero](agents/L1_A3_Zero.md) (Automate), [Gwyn](agents/L1_A3_Gwyn.md) (Liberate), [Holo-Janeway](agents/L1_A3_Holo_Janeway.md) (Command).
